...
* **Frontend React (Fase Atual):** React.js (via Vite), JSX, Componentização (`ProdutoCard`).
...
* [ ] **Atividade 3: Componentização Avançada**
    Uso de `props` customizadas, `children`, estilização avançada dos cards em Grid e criação da interface visual do formulário de cadastro de novos gibis.
...
### Fase 2: Rodando a Aplicação React (Vite)
